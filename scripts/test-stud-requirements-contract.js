...
try {
    ...
    check("FRESH_DATABASE_SCHEMA_V16", () => assert.strictEqual(store.schemaInfo().version, 16));
    ...
    check("V14_TO_V16_MIGRATION", () => assert.strictEqual(legacy.schemaInfo().version, 16));
