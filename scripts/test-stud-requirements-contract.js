...
function stripV15(dbPath) {
    ...
    db.exec(`PRAGMA foreign_keys=OFF;
        ...
        DELETE FROM stud_schema_migrations WHERE version=15;
...
try {
    ...
    check("FRESH_DATABASE_SCHEMA_V15", () => assert.strictEqual(store.schemaInfo().version, 15));
    ...
    check("V14_TO_V15_MIGRATION", () => assert.strictEqual(legacy.schemaInfo().version, 15));
