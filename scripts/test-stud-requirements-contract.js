...
try {
    ...
    check("FRESH_DATABASE_CURRENT_SCHEMA", () => assert.strictEqual(store.schemaInfo().version, 22));
    ...
    check("V14_TO_CURRENT_MIGRATION", () => assert.strictEqual(legacy.schemaInfo().version, 22));
