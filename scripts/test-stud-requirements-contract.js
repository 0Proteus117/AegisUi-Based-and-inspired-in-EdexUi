...
try {
    ...
    check("FRESH_DATABASE_CURRENT_SCHEMA", () => assert.strictEqual(store.schemaInfo().version, 24));
    ...
    check("V14_TO_CURRENT_MIGRATION", () => assert.strictEqual(legacy.schemaInfo().version, 24));
