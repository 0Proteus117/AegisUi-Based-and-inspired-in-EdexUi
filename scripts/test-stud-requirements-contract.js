...
function stripV15(dbPath) {
    ...
    db.exec(`PRAGMA foreign_keys=OFF;
        ...
        DELETE FROM stud_schema_migrations WHERE version IN (15,17,18,19,20);
...
try {
    ...
    check("FRESH_DATABASE_CURRENT_SCHEMA", () => assert.strictEqual(store.schemaInfo().version, 21));
    ...
    check("V14_TO_CURRENT_MIGRATION", () => assert.strictEqual(legacy.schemaInfo().version, 21));
