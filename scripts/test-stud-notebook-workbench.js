...
(async () => {
    ...
    try {
        ...
        check("SCHEMA_CURRENT_NOTEBOOK_DATA_REPOSITORY", () => assert.strictEqual(store.schemaInfo().version, Model.SCHEMA_VERSION) && ["NOTEBOOK", "DATASET", "REPOSITORY_REFERENCE"].every(type => Model.ENTITY_TYPES.includes(type)));
