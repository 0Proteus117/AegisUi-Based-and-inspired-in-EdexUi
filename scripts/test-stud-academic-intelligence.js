...
(async () => {
    ...
    try {
        ...
        check("SCHEMA_CURRENT_RETAINS_CONTEXT_TABLES", () => { assert.strictEqual(store.schemaInfo().version, Model.SCHEMA_VERSION); assert.ok(Model.CONTEXT_RELATION_STATUSES.includes("SUGGESTED")); });
