...
const files = [
    ...
    "src/classes/workspaces/studNotebookRuntime.class.js",
    ...
    "src/classes/workspaces/studAssignmentWorkspace.class.js",
...
const checks = {
    ...
    STUD_COMMAND_CENTER_ACTIVE_SCREENS: commandCenter.includes("STUDENT COMMAND CENTER") && commandCenter.includes('"OVERVIEW", "MODULES", "ASSIGNMENTS", "PROGRESS", "REVISION", "RESEARCH", "DOCUMENTS", "KNOWLEDGE", "AI", "NOTES", "TOOLS", "WORKBENCH", "SERVICES", "MOODLE"'),
    STUD_ASSIGNMENT_WORKSPACE_IS_CANONICAL_COMPOSITION: commandCenter.includes("StudAssignmentWorkspace") && fs.readFileSync(path.join(ROOT, "src/classes/workspaces/studAssignmentWorkspace.class.js"), "utf8").includes("PRIMARY WORK SURFACE"),
    STUD_FORMS_AND_PROVENANCE: commandCenter.includes("CREATE COURSE") && commandCenter.includes("CREATE ASSIGNMENT") && commandCenter.includes("PROVENANCE") && commandCenter.includes("LOCAL SEARCH"),
