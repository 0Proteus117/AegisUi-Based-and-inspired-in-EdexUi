(function(root, factory) {
    ...
    class AssistantLocalChat {
        ...
        buildSystemPrompt({assistantId, mode, memory} = {}) {
            ...
            const runtime = `\n\n[CURRENT RUNTIME CAPABILITIES]\nLocal written chat: ACTIVE.\nCommand router: OFFLINE.\nVoice, STT and TTS: OFFLINE.\nSystem actions, shell commands, file writes and app control: NOT AVAILABLE.\nIf asked for current readiness, say written chat is ready; do not say command execution is ready.\n[/CURRENT RUNTIME CAPABILITIES]`;
            return `${base}\n\n${globalRules}${memoryText}${runtime}`;
        }
