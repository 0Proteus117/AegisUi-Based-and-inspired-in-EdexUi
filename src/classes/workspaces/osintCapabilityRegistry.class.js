(function(root, factory) {
    ...
    const DEFINITIONS = Object.freeze([
        ...
        {id: "GEOSPATIAL_VERIFICATION", name: "Geospatial verification", description: "Public geospatial verification context.", inputTypes: ["MANUAL_QUERY"], outputTypes: ["PUBLIC_REFERENCE_CONTEXT"], supportsMultipleProviders: true, supportsEvidence: false, supportsCancellation: false, riskClass: "PASSIVE", enabled: false},
