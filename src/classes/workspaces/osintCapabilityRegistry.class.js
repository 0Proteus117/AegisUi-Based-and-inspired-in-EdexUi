(function(root, factory) {
    ...
    const DEFINITIONS = Object.freeze([
        ...
        {id: "SOURCE_VERIFICATION", name: "Research, documents and source verification", description: "Explicit, bounded source normalization, DOI metadata, local PDF context and archive observations.", inputTypes: ["PUBLIC_URL", "DOI", "LOCAL_PDF"], outputTypes: ["NORMALIZED_SOURCE_CONTEXT", "DOCUMENT_METADATA", "PROVIDER_OBSERVATION"], supportsMultipleProviders: true, supportsEvidence: true, supportsCancellation: true, riskClass: "PASSIVE", enabled: true},
        {id: "ENTITY_RESOLUTION", name: "Identity and entity resolution", description: "Explicit local entities, provenance-aware attributes and evidence-backed relationship correlation.", inputTypes: ["ANALYST_ENTITY", "NORMALIZED_OBSERVATION", "CASE_EVIDENCE"], outputTypes: ["ENTITY_PROFILE", "RELATIONSHIP_GRAPH", "ENTITY_EVIDENCE_SNAPSHOT"], supportsMultipleProviders: false, supportsEvidence: true, supportsCancellation: false, riskClass: "PASSIVE", enabled: true},
        ...
        {id: "INFRASTRUCTURE_CONTEXT", name: "Domain & infrastructure context", description: "Explicit, passive public domain, DNS and public-IP network context.", inputTypes: ["DOMAIN", "PUBLIC_IP", "HTTP_URL_HOST"], outputTypes: ["NORMALIZED_INFRASTRUCTURE_CONTEXT", "PROVIDER_OBSERVATION"], supportsMultipleProviders: true, supportsEvidence: true, supportsCancellation: true, riskClass: "PASSIVE", enabled: true},
        ...
        {id: "VISUAL_MEDIA_VERIFICATION", name: "Visual and media verification", description: "Passive, explicit inspection of user-supplied image metadata and contextual signals.", inputTypes: ["LOCAL_IMAGE"], outputTypes: ["NORMALIZED_MEDIA_METADATA", "ORIGINAL_MEDIA_HASH", "OPTIONAL_GEO_CONTEXT"], supportsMultipleProviders: false, supportsEvidence: true, supportsCancellation: false, riskClass: "PASSIVE", enabled: true},
