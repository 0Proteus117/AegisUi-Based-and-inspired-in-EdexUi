...
class StudMoodleWorkspace {
    ...
    async handleClick(event) {
        ...
        if (kind === "connect" || kind === "open-web" || kind === "reauthenticate") { try { await this.request("stud-moodle-open-web", {}); this.state.error = ""; } catch (error) { this.state.error = error.message; this.parent.render(); } return true; }
