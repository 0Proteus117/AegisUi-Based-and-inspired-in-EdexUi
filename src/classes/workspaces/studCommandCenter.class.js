...
class StudCommandCenter {
    ...
    renderAssignmentDetail(context) {
        const {assignment, provenance, relationships, references, resources, notes = [], papers = [], links = [], conflicts = [], status = "CLEAN"} = context;
