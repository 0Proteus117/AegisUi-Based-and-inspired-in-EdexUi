(() => {
    ...
    window.workspaceDefinitions = [
        ...
        },
        {
            ...
            description: "Local-first academic command center for courses, assignments, resources, notes, references and provenance.",
            status: "active",
            implementation: "student command center · local first",
            categories: ["overview", "courses", "assignments", "resources", "notes", "provenance", "search"],
            quickActions: [],
            recommendedTools: [],
            widgets: [],
