...
const STUD_CHANNELS = Object.freeze([
    "stud-storage-profiles", "stud-storage-profile-choose", "stud-storage-profile-reconnect", "stud-storage-catalog", "stud-storage-transfer-prepare", "stud-storage-transfer-read", "stud-storage-transfer-execute", "stud-storage-transfer-cancel", "stud-storage-transfer-rollback", "stud-storage-history",
    ...
    "stud-claim-list", "stud-claim-read", "stud-claim-create", "stud-claim-update", "stud-claim-review", "stud-claim-create-revision", "stud-evidence-list", "stud-evidence-read", "stud-evidence-create", "stud-evidence-update", "stud-evidence-review", "stud-claim-evidence-link", "stud-claim-evidence-update", "stud-claim-evidence-review", "stud-claim-evidence-revise", "stud-evidence-map", "stud-evidence-source-preview",
    "stud-faculty-scout-state", "stud-faculty-observation-create", "stud-faculty-identity-discover", "stud-faculty-identity-confirm", "stud-faculty-identity-reject", "stud-faculty-publications-discover", "stud-faculty-publication-import", "stud-faculty-publication-dismiss",
    "stud-composition-state", "stud-composition-create", "stud-composition-update", "stud-composition-section-add", "stud-composition-section-update", "stud-composition-section-remove", "stud-composition-requirement-set", "stud-composition-claim-link", "stud-composition-evidence-link", "stud-composition-reference-unlink", "stud-composition-review", "stud-composition-create-revision", "stud-composition-readiness", "stud-composition-section-context", "stud-draft-create", "stud-draft-read", "stud-draft-version-read", "stud-draft-save-version", "stud-draft-diff",
